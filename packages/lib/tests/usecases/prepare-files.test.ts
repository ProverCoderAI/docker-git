  ...
  it.effect("force-env refresh rewrites managed templates", () =>
    withTempDir((root) =>
      Effect.gen(function*(_) {
        ...
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/authorized-keys:ro')
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/env-global:ro')
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/env-project:ro')
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/project-auth/codex:ro')
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/shared-auth/codex:ro')
        expect(composeBefore).toContain(':/opt/docker-git/bootstrap/source/project-auth/claude:ro')
