...
// CHANGE: run the official Grok CLI device-code login flow inside the auth container
// WHY: `docker-git auth grok login` should work in the headless Docker auth container
// REF: issue-304
