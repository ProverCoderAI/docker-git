...
impl BrowserConnection {
    ...
    /// Starts the browser container for a project (dg-*-browser) with noVNC and CDP exposed
    pub async fn start_browser(&self, project_id: &str) -> Result<String> {
        ...
        Ok(format!("Browser started for {} with noVNC on :6080 and CDP on :9223", project_id))
    }
